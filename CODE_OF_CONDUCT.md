...
- Publishing another person's financial data or encouraging unsafe disclosure of sensitive data
...
Report abusive, harassing, or otherwise unacceptable behavior privately through the maintainer contact process described in [SECURITY.md](SECURITY.md). State that the report concerns community conduct rather than a product vulnerability. Do not open a public issue about a conduct incident.
