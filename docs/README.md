...
- [Getting started](getting-started.md) — first local run, personal workspace, household creation, and invitations
...
- [Security policy](../SECURITY.md) — privacy boundaries, roles, installation authority, deployment assumptions, and private reporting
